  ...
  <div class="register">
    <div class="registerContainer">
      ...
      <div class="registerForm">
        ...
        <div>
          <p>Zip/postal code</p>
          <input type="text" placeholder="Zip/postal code" v-model="zip" />
        </div>
        <div>
          <p>Country</p>
        ...
        <div>
          <p>State/Province</p>
          <input type="text" placeholder="State/Province" v-model="state" />
        </div>
      </div>
      <button class="primary-btn" @click="register()">Register</button>
    </div>
  </div>
</template>
